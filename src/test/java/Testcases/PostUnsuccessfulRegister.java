...
public class PostUnsuccessfulRegister {
  @Test
...
//	  Sheet sheet = wb.getSheet(2);
	  ...
	  Cell c2 = g.getsheet().getCell(3, 14);
	  String email = c2.getContents();
	  Cell c3 = g.getsheet().getCell(6, 14);
	  ...
	  String jsonstring = "{\n"
		...
		if(response.getStatusCode() == 400)
		  {
			  g.writeexcel("testcases", 12, 12, "passed");
		  }
		  else
		  {
			  g.writeexcel("testcases", 12, 12, "failed");
		  }
  }
}
